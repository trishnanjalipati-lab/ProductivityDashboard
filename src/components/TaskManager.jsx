...
function Taskmanager() {
  ...
  return (
    ...
    <input
      className='border-black bg-white p-1 dark:text-black text-lg'
      value={task}
    ...
    {displayTasks.map((value,index)=>(
      ...
      <div className={`flex justify-between bg-white text-black rounded-lg px-3 py-2 text-xl break-all  ${value.completed?"line-through":""}`} key={index} id={index}>
        {value.text}
